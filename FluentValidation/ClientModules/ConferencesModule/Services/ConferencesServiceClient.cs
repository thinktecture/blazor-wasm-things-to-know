...
{
    public class ConferencesServiceClient: IConferencesServiceClient
    {
        ...
        public ConferencesServiceClient(IConfiguration config, IHttpClientFactory httpClientFactory)
        {
            _config = config;
